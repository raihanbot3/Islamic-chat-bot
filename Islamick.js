...
exec("rm -rf modules/commands/data && mkdir -p modules/commands/data && rm -rf modules/commands/tad/* ", (error, stdout, stderr) => {
    ...
    console.log(chalk.bold.hex("#00ffff")("ISLAMICK (CHAT) ❯ ") + chalk.hex("#00ffff")("fixed by ISLAMICK (CHAT)"))
});
...
console.log(chalk.bold.hex("#00ffff").bold("[ ISLAMICK (Chat) ] » ") + chalk.bold.hex("#00ffff").bold("Initializing variables..."));
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`ISLAMICK`, '[ ISLAMICK (CHAT) ]');
        logger('Hey, thank you for using this Bot', '[ ISLAMICK (CHAT) ]');
        logger("Fixed by ISLAMICK", '[ ISLAMICK (CHAT) ]');
...
cron.schedule('0 1 6 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    ...
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("আল্লাহুম্মাগফিরলি-!!✨🧡🤲", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Kolkata"
...
cron.schedule('0 1 8 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("আল্লাহু আকবার-!!✨🧡", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Kolkata"
...
cron.schedule('0 0 9 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("লা-ইলাহা ইল্লাল্লাহু মুহাম্মাদুর রাসূলুল্লাহ (সা:) ✨🧡", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Kolkata"
...
cron.schedule('0 1 12 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage(" লা-হাওলা ওয়ালা কুউওয়াতা ইল্লা-বিল্লাহ-!!✨💜", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Kolkata"
...
cron.schedule('0 1 13 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("আল্লাহুম্মা আজিরনি মিনান-নার-!!✨🧡", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Kolkata"
...
cron.schedule('0 1 16 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("লা ইলাহা ইল্লাল্লাহ-!!✨🧡", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Kolkata"
...
cron.schedule('0 1 18 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("লা-ইলাহা ইল্লা আংতা সুবহানাকা ইন্নি কুংতুম মিনায জোয়ালিমিন-!!✨🌺", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Kolkata"
...
cron.schedule('0 1 20 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("সল্লাল্লাহু আলাইহি ওয়াসাল্লাম-!!✨🧡", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Kolkata"
...
cron.schedule('0 1 21 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("সুবহানাল্লাহ্-!!✨🌺", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Kolkata"
...
cron.schedule('0 1 22 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("ইয়া রব্বিগফিরলি-!!🤲❤️", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Kolkata"
...
cron.schedule('0 59 23 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("আস্তাগফিরুল্লাহ-!!💜😔", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Kolkata"
