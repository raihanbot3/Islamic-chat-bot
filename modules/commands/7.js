module.exports.config = {
  ...
  module.exports.handleReply = async function ({ event, api , args, handleReply, Users}){
    const axios = require("axios");
             ...
             if(event.body == "1"){
         var url = "https://3f5376b5-b13e-4a49-a5a0-9772048c9386-00-47tbgsnyrwkn.worf.replit.dev/ai"
}
         else if(event.body == "2"){
         var url = "https://3f5376b5-b13e-4a49-a5a0-9772048c9386-00-47tbgsnyrwkn.worf.replit.dev/bot"
}
         else if(event.body == "3"){
         var url = "https://3f5376b5-b13e-4a49-a5a0-9772048c9386-00-47tbgsnyrwkn.worf.replit.dev/cosplay"
}
          else if(event.body == "4"){
          var url = "https://3f5376b5-b13e-4a49-a5a0-9772048c9386-00-47tbgsnyrwkn.worf.replit.dev/gai"
}
          else if(event.body == "5"){
          var url = "https://3f5376b5-b13e-4a49-a5a0-9772048c9386-00-47tbgsnyrwkn.worf.replit.dev/ig"
}
         else if(event.body == "6"){
          var url = "https://3f5376b5-b13e-4a49-a5a0-9772048c9386-00-47tbgsnyrwkn.worf.replit.dev/trai"
}
         else if(event.body == "7"){
          var url = "https://3f5376b5-b13e-4a49-a5a0-9772048c9386-00-47tbgsnyrwkn.worf.replit.dev/tw"
}
