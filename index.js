...
monitor.on('up', (res) => console.log(chalk.bold.hex("#00FF00")("[ ISLAMICK ] ❯ ") + chalk.hex("#00FF00")(`${res.website}`)))
...
function startBot(message) {
    ...
    const child = spawn("node", ["--trace-warnings", "--async-stack-traces", "Islamick.js"], {
        cwd: __dirname,
        stdio: "inherit",
        shell: true
    });
